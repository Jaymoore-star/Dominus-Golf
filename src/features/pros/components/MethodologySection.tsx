export function MethodologySection() {
  return (
    <section className="w-full bg-background border-b border-border py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-16">
            ...
            <div className="bg-accent/5 border border-accent/30 p-8 sm:p-10 relative overflow-hidden">
              <h3 className="font-serif text-xl sm:text-2xl font-bold text-foreground mb-6">
          ...
          <div className="text-center bg-muted border border-border p-10 sm:p-12">
