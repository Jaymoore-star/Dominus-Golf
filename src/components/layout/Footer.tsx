...
const footerLinks = {
  ...
  'Apparel': [
    ...
    // Pointed at the DOMINUS HER page while it was published; back to the
    // women's listing, which mirrors Men's Tees, while that page is
    // unpublished pending legal review.
    { label: "Women's Tees", href: '/shop/womens-gear' },
