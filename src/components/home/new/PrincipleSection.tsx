...
export const PrincipleSection = () => {
  return (
    <section className="py-20 sm:py-24 bg-gray-50 text-black overflow-hidden">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div 
          ...
          className="max-w-6xl mx-auto bg-gray-100 text-black p-12 md:p-24 relative overflow-hidden flex flex-col md:flex-row gap-10 items-center"
        >
          <div className="relative z-10 flex-1">
            <motion.h2 
              ...
              className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-10 font-serif uppercase leading-[1.1] text-accent"
            >
            ...
            <motion.p 
              ...
              className="text-lg sm:text-xl text-gray-600 font-sans leading-relaxed italic"
            >
          ...
          <div className="flex flex-col items-center md:items-start gap-6 relative z-10">
            ...
            <div className="text-5xl sm:text-6xl font-bold font-serif leading-none tracking-tighter">10X</div>
