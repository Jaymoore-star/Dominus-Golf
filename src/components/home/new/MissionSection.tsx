    ...
    <section className="py-24 bg-zinc-950 text-white relative">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-bold tracking-tight mb-8 font-serif uppercase leading-tight">
              MORE THAN A GOLF COMPANY
            </h2>
            <p className="text-gray-400 text-lg md:text-2xl mb-12 font-sans leading-relaxed">
              Dominus Golf supports player development through structured access programs, including the <span className="text-white font-bold">Dominus Golf Development Grant</span>, designed to help emerging golfers access training, equipment, and competitive opportunities. The brand also supports community-based golf events focused on participation and skill development.
            </p>
            <a 
              href="/about" 
