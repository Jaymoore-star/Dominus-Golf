      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 items-center">
          ...
          >
            ...
            <p className="text-gray-600 text-lg md:text-2xl mb-14 font-sans leading-relaxed">
            ...
            <a 
              href="/about" 
              className="inline-block px-12 py-5 border border-black/20 text-black font-bold tracking-widest uppercase hover:bg-black hover:text-white transition-all text-sm"
            >
